...
const Returns = () => {
  return (
    <ContentWrap>
        ...
        <P>
        This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from TheThunderBike.com.
</P>
...
<P>
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:sales@thethunderbike.com">sales@thethunderbike.com</a>
</P>
    </ContentWrap>
  );
};
